...
function generateTTF(font) {
  ...
  if (font.width !== font.height) throw Error('Dimenisions not same. Width: '+font.width+' and height: '+font.height);
  ...
  _.forEach(font.glyphs, function (glyph) {
    glyph.ttfContours = utils.roundPoints(glyph.ttfContours, 1000/font.height);
